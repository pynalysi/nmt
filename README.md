...
-   [基本](#basic)
    ...
    -   [Hands-on – _Let's train an NMT model_](#hands-on--lets-train-an-nmt-model)
    -   [Inference – _How to generate translations_](#inference--how-to-generate-translations)
-   [Intermediate](#intermediate)
    ...
    -   [Hands-on – _Building an attention-based NMT model_](#hands-on--building-an-attention-based-nmt-model)
...
-   [Benchmarks](#benchmarks)
    ...
    -   [WMT English-German — _Full Comparison_](#wmt-english-german--full-comparison)
...
In this tutorial, we consider as examples a _deep multi-layer RNN_ which is
...
**_Important note_**: It's worth pointing out that we divide the loss by
...
Once the iterator is initialized, every _session.run_ call that accesses source
...
Note that the same _dynamic_decode()_ API call is used, similar to the
